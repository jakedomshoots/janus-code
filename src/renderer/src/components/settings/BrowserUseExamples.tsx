...
const EXAMPLE_PROMPTS: string[] = [
  'Using Janus CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the Janus CLI and tell me what's blocked.",
  'With Janus CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
