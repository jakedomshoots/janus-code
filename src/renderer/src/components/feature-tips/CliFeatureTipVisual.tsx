...
const CLI_AGENT_COMMANDS = [
  'janus worktree create --name auth-pr-1',
  'janus worktree create --name auth-pr-2',
  'janus orchestration dispatch --task pr1 --to w1',
  'janus orchestration dispatch --task pr2 --to w2'
]
