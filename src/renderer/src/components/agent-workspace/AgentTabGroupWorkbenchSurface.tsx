...
// Why: simulator and editor tabs need a tab-group body anchor in the agent pane
// without forcing browser-only overlay routing (agentBrowserWorkbenchMode).
export function AgentTabGroupWorkbenchSurface({
  worktreeId
}: {
  worktreeId: string
  ...
  return (
    <div
      ...
      data-agent-tab-group-workbench-surface="true"
    >
      <DndContext
      ...
      >
        <TabGroupPanel
          ...
          agentWorkbenchSurfaceMode={true}
          isFocused={true}
