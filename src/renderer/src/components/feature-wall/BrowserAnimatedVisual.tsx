...
// Why: this animation tells the full Janus Code story end-to-end — the user opens a
...
// Janus Code's dropdown/popover primitives while staying inside the storyboard DOM.
