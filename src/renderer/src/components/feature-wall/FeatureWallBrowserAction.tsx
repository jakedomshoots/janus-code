...
// needs the Janus CLI and browser skill, not Computer Use or orchestration.
...
// The grab→agent flow relies on the Janus CLI and browser skill, so offer the same
// install action the Enable Janus CLI step uses, scoped to just browser use.
