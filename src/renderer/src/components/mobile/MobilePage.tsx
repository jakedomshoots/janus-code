...
import { useMobileInstallQrUrl } from './use-mobile-install-qr-url'
...
export default function MobilePage(): React.JSX.Element {
  ...
  const installQrUrl = useMobileInstallQrUrl({ stage, platform })
  ...
  return (
    <div className="mobile-page-root">
      ...
      <MobilePageHeroSection
        ...
        onOpenPairingIssueSettings={openRemoteHostsSettings}
