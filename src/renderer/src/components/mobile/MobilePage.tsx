...
import { MobilePageHeroContent, type MobilePagePairingIssue } from './MobilePageHeroContent'
import { useMobileInstallQr } from './useMobileInstallQr'
import { useMobilePageEscapeClose } from './useMobilePageEscapeClose'
...
export default function MobilePage(): React.JSX.Element {
  ...
  const [pairingIssue, setPairingIssue] = useState<MobilePagePairingIssue | null>(null)
  ...
  useMobileInstallQr({ platform, setInstallQrUrl, stage })
  ...
  return (
    <div className="mobile-page-root">
      ...
      <MobilePageHeroContent
        ...
        pairingIssue={pairingIssue ? { ...pairingIssue, onAction: openRemoteHostsSettings } : null}
