...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'janus orchestration send --to <handle> --subject <text> [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--task-id <id>] [--dispatch-id <id>] [--files-modified <csv>] [--report-path <path>] [--phase <text>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'from',
  ...
  },
  {
    ...
    usage:
      'janus orchestration check [--terminal <handle>] [--unread | --all] [--types <type,...>] [--inject] [--wait] [--timeout-ms <n>] [--json]\n' +
  ...
  },
  {
    ...
    usage: 'janus orchestration reply --id <msg_id> --body <text> [--from <handle>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id', 'body', 'from']
  },
  {
    path: ['orchestration', 'inbox'],
    summary: 'Show messages across (or for) recipients',
    usage: 'janus orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage: 'janus orchestration task-list [--status <status>] [--ready] [--json]',
  ...
  },
  {
    ...
    usage:
      'janus orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--inject] [--dry-run] [--return-preamble] [--json]',
  ...
  },
  {
    ...
    usage:
      'janus orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'janus orchestration run-stop [--json]',
  ...
  },
  {
    ...
    usage: 'janus orchestration gate-resolve --id <gate_id> --resolution <text> [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id', 'resolution']
  },
  {
    path: ['orchestration', 'gate-list'],
    summary: 'List decision gates',
    usage: 'janus orchestration gate-list [--task <task_id>] [--status <status>] [--json]',
  ...
  },
  {
    ...
    usage: 'janus orchestration reset [--all | --tasks | --messages] [--json]',
