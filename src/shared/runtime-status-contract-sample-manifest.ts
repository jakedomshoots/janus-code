...
export type RuntimeStatusPortingContractSampleManifest = {
  ...
  artifactJsonPath: typeof RUNTIME_STATUS_PORTING_CONTRACT_SAMPLE_MANIFEST_JSON_PATH
...
export function getRuntimeStatusPortingContractSampleManifest(): RuntimeStatusPortingContractSampleManifest {
  return {
    ...
    artifactJsonPath: RUNTIME_STATUS_PORTING_CONTRACT_SAMPLE_MANIFEST_JSON_PATH,
