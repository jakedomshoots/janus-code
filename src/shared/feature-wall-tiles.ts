...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    caption:
      'Run agents on a remote machine with the same Janus Code editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
  ...
  },
  {
    ...
    title: 'Janus CLI',
    caption:
      'Agents can drive Janus Code too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
