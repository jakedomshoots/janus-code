...
export type RuntimePortingDomainSummary = {
  ...
  firstSliceContractSampleExpectedResults: RuntimePortingFirstSliceContractSamples[number]['expectedResult'][]
  ...
  firstSliceContractSampleManifestExpectedResults: RuntimePortingFirstSliceContractSampleManifestSamples[number]['expectedResult'][]
  firstSliceContractSampleManifestValidSampleExpectedResult: RuntimePortingFirstSliceContractValidSampleExpectedResult
  firstSliceContractSampleManifestInvalidSampleExpectedResult: RuntimePortingFirstSliceContractInvalidSampleExpectedResult
