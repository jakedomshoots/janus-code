  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/jakedomshoots/janus-code/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/jakedomshoots/janus-code/releases/download/v1.4.1/Janus%20Code-1.4.1-arm64-mac.zip'
      ])
    }
  )
