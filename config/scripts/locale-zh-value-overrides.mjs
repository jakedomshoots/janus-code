...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Janus Code': 'Janus Code',
  'Janus Code first': 'Janus Code 优先',
  'Janus Mobile': 'Janus Mobile',
  'Janus Code logo': 'Janus Code 标志',
  'Enjoying Janus Code?': '喜欢 Janus Code 吗？',
  'Get to know Janus Code': '了解 Janus Code',
  'Expand Janus Code': '展开 Janus Code',
  'Support Janus Code': '支持 Janus Code',
  'Restarting Janus Code…': '正在重启 Janus Code…',
  'Janus Code Attribution': 'Janus Code 归因',
  ...
  "Give agents direct access to Janus Code's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Janus Code 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Janus Code. It is still on your disk.': '来自 Janus Code。它仍保留在您的磁盘上。',
