...
- Runtime status contract artifact notes that non-TypeScript runtime adapters use to validate `status.get` compatibility. See [Runtime Status Contract Artifact](./runtime-status-contract-artifact.md).
