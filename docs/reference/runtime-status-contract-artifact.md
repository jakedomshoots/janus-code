...
- `summary`: portable contract metadata, required fields, `versionedFields`, `nonNegativeIntegerFields`, `stringFields`, `arrayFields`, `numericFields`, enum values, and constraints.
