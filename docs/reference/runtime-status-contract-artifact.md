...
The summary also includes `firstSliceContractRequiredFields` so sidecar readers can inspect the first slice's minimum payload surface before loading the full JSON Schema.
