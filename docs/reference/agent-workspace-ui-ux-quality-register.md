...
coverage for the approval-state agent workspace at a 1280x720 viewport. The
score is not 100 yet because multi-worktree compare, review-only, source-control
diff actions, narrow/mobile-like layouts, and installed-app smoke still need
...
- Right panel tabs: Changes, Review, Plan, replay export, risk/protected-resource
