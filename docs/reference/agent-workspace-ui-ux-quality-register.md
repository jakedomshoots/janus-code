...
verification, partial telemetry, changed-file evidence, and a multi-worktree
Best-of-N compare path below 1100px. The score is not 100 yet because
installed-app smoke, manual passes beyond seeded states, unsupported runtime
states, deeper memory states, and sub-1024/mobile-like widths still need current
end-to-end evidence.
...
- Sub-1024/mobile-like widths and smaller-height checks for the above
  surfaces.
